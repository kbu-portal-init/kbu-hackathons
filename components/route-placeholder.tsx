    ...
    return (
        <main className="mx-auto flex w-full max-w-7xl flex-1 items-center px-6 py-24 lg:px-8">
            <div className="max-w-2xl">
                <p className="text-sm font-semibold uppercase tracking-widest text-cyan-600">{eyebrow}</p>
                ...
                <Link
                    href="/"
                    className="mt-8 inline-flex rounded-full bg-cyan-600 px-5 py-3 font-semibold text-white hover:bg-cyan-700"
                >
                    Back to home
                </Link>
            </div>
