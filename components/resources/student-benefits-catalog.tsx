...
export function StudentBenefitsCatalog() {
    ...
    return (
        <div>
            {/* Hero Header */}
            <div className="relative mb-8 overflow-hidden rounded-3xl border border-cyan-200/70 bg-gradient-to-br from-cyan-50/70 via-white to-amber-50/40 p-5 sm:mb-12 sm:p-10 lg:p-12 dark:border-cyan-900/40 dark:from-zinc-900 dark:via-zinc-950 dark:to-cyan-950/20">
                <div className="relative z-10 max-w-3xl">
                    <div className="inline-flex items-center gap-2 rounded-full border border-cyan-200/80 bg-white/90 px-3 py-1 text-xs font-semibold text-cyan-700 shadow-2xs backdrop-blur-xs dark:border-cyan-900/60 dark:bg-zinc-900/90 dark:text-cyan-300">
                    ...
                    <div className="mt-5 flex flex-col gap-2.5 sm:flex-row sm:items-center">
                        <button
                            ...
                            className="inline-flex items-center justify-center gap-2 rounded-xl border border-cyan-300/80 bg-cyan-100/70 px-4 py-2.5 text-xs font-semibold text-cyan-800 transition hover:bg-cyan-200/80 active:scale-95 sm:text-sm dark:border-cyan-800 dark:bg-cyan-950/60 dark:text-cyan-200"
                        >
                ...
                <div
                    aria-hidden="true"
                    className="pointer-events-none absolute -right-20 -top-20 h-72 w-72 rounded-full bg-cyan-400/10 blur-3xl dark:bg-cyan-500/10"
                />
            </div>
            ...
            <div className="mb-6 space-y-3 sm:mb-8 sm:space-y-4">
                <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    {/* Search Box */}
                    <div className="relative flex w-full items-center gap-2 rounded-2xl border border-zinc-200 bg-white px-3.5 py-2.5 shadow-2xs transition focus-within:border-cyan-500 focus-within:ring-2 focus-within:ring-cyan-500/20 sm:max-w-xs dark:border-zinc-800 dark:bg-zinc-900">
            ...
            {filteredBenefits.length > 0 ? (
                <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
                    {filteredBenefits.map((benefit) => (
                        <div
                            key={benefit.id}
                            className="group flex flex-col justify-between rounded-3xl border border-zinc-200/80 bg-white p-4 shadow-2xs transition hover:-translate-y-1 hover:border-cyan-500/40 hover:shadow-lg sm:p-6 dark:border-zinc-800 dark:bg-zinc-900/70 dark:hover:border-cyan-500/30"
                        >
                            <div>
                                ...
                                <div className="mb-3.5 flex items-center justify-between gap-2 sm:mb-4">
                                    <Link
                                        ...
                                        className="flex h-11 w-11 items-center justify-center rounded-2xl bg-cyan-50 text-cyan-600 transition group-hover:bg-cyan-600 group-hover:text-white sm:h-12 sm:w-12 dark:bg-cyan-950/60 dark:text-cyan-300 dark:group-hover:bg-cyan-600 dark:group-hover:text-white"
                                    ...
                                    <div className="flex flex-wrap items-center gap-1.5">
                                        ...
                                        {benefit.badge && (
                                            <span className="rounded-full bg-cyan-50 px-2 py-0.5 text-[10px] font-semibold text-cyan-700 sm:px-2.5 sm:text-xs dark:bg-cyan-950/60 dark:text-cyan-300">
                                                {benefit.badge}
                                            </span>
                                        )}
                                    </div>
                                ...
                                <Link
                                    href={`/resources/${benefit.id}`}
                                    className="block text-base font-bold text-zinc-900 transition group-hover:text-cyan-600 sm:text-lg lg:text-xl dark:text-zinc-50 dark:group-hover:text-cyan-400"
                                >
                                    {benefit.title}
                                </Link>
                                ...
                                <div className="mt-3.5 border-t border-zinc-100 pt-3 dark:border-zinc-800/80">
                                    ...
                                    <ul className="mt-2 space-y-1.5">
                                        {benefit.perks.slice(0, 3).map((perk) => (
                                            ...
                                            >
                                                <CheckCircle2 className="mt-0.5 h-3.5 w-3.5 shrink-0 text-cyan-600 dark:text-cyan-400" />
                            ...
                            <div className="mt-5 border-t border-zinc-100 pt-3.5 dark:border-zinc-800/80">
                                <div className="flex items-center gap-2">
                                    <Link
                                        href={`/resources/${benefit.id}`}
                                        className="flex flex-1 items-center justify-center gap-1.5 rounded-xl bg-cyan-50 px-3.5 py-2 text-xs font-semibold text-cyan-700 transition hover:bg-cyan-600 hover:text-white dark:bg-cyan-950/60 dark:text-cyan-300 dark:hover:bg-cyan-600 dark:hover:text-white"
                                    >
                ...
                <div className="rounded-3xl border border-dashed border-zinc-300 bg-white p-12 text-center dark:border-zinc-800 dark:bg-zinc-900/40">
                    ...
                    <button
                        ...
                        className="mt-4 rounded-full bg-cyan-600 px-5 py-2 text-xs font-semibold text-white transition hover:bg-cyan-700"
                    >
                        Reset Filters
                    </button>
                </div>
