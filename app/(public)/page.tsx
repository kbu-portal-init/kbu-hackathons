...
export default async function Home() {
    ...
    return (
        <main>
            <section className="overflow-hidden border-b border-cyan-100 bg-cyan-50 dark:border-cyan-950/50 dark:bg-cyan-950/20">
                <div className="mx-auto grid max-w-7xl gap-12 px-6 py-20 sm:py-28 lg:grid-cols-[1.1fr_0.9fr] lg:items-center lg:px-8">
                    <div>
                        <p className="mb-5 inline-flex rounded-full border border-cyan-200 bg-white px-3 py-1 text-sm font-semibold text-cyan-700 dark:border-cyan-900 dark:bg-zinc-950 dark:text-cyan-300">
                        ...
                        <h1 className="max-w-3xl text-5xl font-black tracking-tight text-zinc-950 sm:text-7xl dark:text-white">
                            Build. Connect. <span className="text-cyan-600">Compete.</span>
                        </h1>
            ...
            <section className="mx-auto max-w-7xl px-6 py-20 lg:px-8">
                <div className="flex items-end justify-between gap-4">
                    <div>
                        <p className="text-sm font-semibold uppercase tracking-widest text-cyan-600">Get involved</p>
                        <h2 className="mt-2 text-3xl font-bold tracking-tight">Upcoming events</h2>
                    </div>
                    <Link
                        href="/events"
                        className="hidden items-center gap-1 text-sm font-semibold text-cyan-600 sm:flex"
                    >
                ...
                <div className="mt-8 grid gap-5 md:grid-cols-3">
                    {events.map(([title, date, type]) => (
                        <article
                            key={title}
                            className="rounded-2xl border border-zinc-200 p-6 hover:shadow-lg hover:shadow-cyan-100 dark:border-zinc-800 dark:hover:shadow-none"
                        >
                            <p className="text-sm font-medium text-cyan-600">{type}</p>
                            <h3 className="mt-8 text-xl font-bold">{title}</h3>
                            <p className="mt-2 text-sm text-zinc-500 dark:text-zinc-400">{date}</p>
                            <Link
                                href="/events"
                                className="mt-6 inline-flex items-center gap-1 text-sm font-semibold hover:text-cyan-600"
                            >
            ...
            <section className="bg-zinc-50 dark:bg-zinc-900/50">
                <div className="mx-auto grid max-w-7xl gap-12 px-6 py-20 lg:grid-cols-[0.8fr_1.2fr] lg:px-8">
                    <div>
                        <p className="text-sm font-semibold uppercase tracking-widest text-cyan-600">Stay informed</p>
                        ...
                        <Link
                            href="/announcements"
                            className="mt-6 inline-flex items-center gap-1 font-semibold text-cyan-600"
                        >
                    ...
                    <div className="divide-y divide-zinc-200 rounded-2xl border border-zinc-200 bg-white dark:divide-zinc-800 dark:border-zinc-800 dark:bg-zinc-950">
                        <Link href="/announcements" className="block p-5 hover:bg-cyan-50/50 dark:hover:bg-cyan-950/20">
                        ...
                        <Link href="/announcements" className="block p-5 hover:bg-cyan-50/50 dark:hover:bg-cyan-950/20">
                            <p className="text-xs font-semibold uppercase tracking-wider text-cyan-600">For teams</p>
